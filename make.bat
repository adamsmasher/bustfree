...
rgblink -d -m bustfree.map -n bustfree.sym -o bustfree.gb ball.o bustfree.o game.o header.o input.o oam.o paddle.o sprites.o stage.o tiles.o titlescreen.o vblank.o
