...
rgblink -d -m bustfree.map -n bustfree.sym -o bustfree.gb ball.o bustfree.o font.o game.o gameover.o header.o input.o oam.o paddle.o sprites.o stage.o stat.o tiles.o titlescreen.o vblank.o
